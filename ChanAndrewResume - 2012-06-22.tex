...
\vspace{-2.5mm}
    ...
    %A Software Development full-time position with a focus in entertainment, gaming, or mobile.
    A Software Development or Project Management full-time position with a focus in entertainment, gaming, or mobile.
...
\sectionline
    ...
    \textls[-10]{\textbf{Languages}: \textsl{Proficient} - Java, C  \textsl{Familiar} - C++, Ruby on Rails, Python, Perl, JSP, Javscript, Android SDK}\\
